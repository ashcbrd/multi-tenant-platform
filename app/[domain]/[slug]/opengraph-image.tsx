...
export default async function InfoOG({
  params,
}: {
  ...
  SELECT info.title, info.description, info.image, "user".name as "authorName", "user".image as "authorImage"
  FROM "Info" AS info
  INNER JOIN "Site" AS site ON info."siteId" = site.id 
