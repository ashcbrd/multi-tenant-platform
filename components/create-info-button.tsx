...
export default function CreateInfoButton() {
    ...
    <button
      onClick={() =>
        startTransition(async () => {
          const info = await createInfo(null, id, null);
          va.track("Created Info");
          router.refresh();
      ...
      disabled={isPending}
    >
      {isPending ? <LoadingDots color="#808080" /> : <p>Add Information</p>}
    </button>
  );
}
